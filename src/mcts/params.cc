...
const OptionId SearchParams::kSendJsonInfoId{
    "json-info", "UCI_jsoninfo", "Send thinking information in Json format."};
...
void SearchParams::Populate(OptionsParser* options) {
  ...
  options->Add<BoolOption>(kSendJsonInfoId) = false;
...
SearchParams::SearchParams(const OptionsDict& options)
    : options_(options),
      ...
      kSendJsonInfo(options.Get<bool>(kSendJsonInfoId)) {
